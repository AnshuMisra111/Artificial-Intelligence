  ...
  while (len(traverse) != 0):
    ...
    if ((x >= 0) and (x < row)) and ((y >= 0) and (y < column)):
        ...
        if wall[x][y] == True:
            ...
            list1 = []
            if (x - 1 >= 0) and (x - 1 < row) and (y >= 0) and (y < column)and (flag[x-1][y]==False): #and (wall[x - 1][y] == False) and (
            ...
            list1 = []
            if (x >= 0) and (x < row) and (y - 1 >= 0) and (y - 1 < column)and (flag[x][y-1]==False): #and (wall[x][y - 1] == False) and (
